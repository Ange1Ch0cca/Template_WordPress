...
<section id="contact" class="contact">
  <div class="container">
    ...
    <div class="section-title">
      ...
      <h2>Contáctanos</h2>
      <p>Ponte en contacto con nosotros para discutir cómo podemos colaborar en tu próximo proyecto de desarrollo web, diseño gráfico o software</p>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <form id="whatsapp-form" role="form" class="php-email-form">
          <div class="row">
            ...
            <div class="col-md-6 form-group">
              <input type="text" name="company" class="form-control" id="company" placeholder="Empresa" required>
            </div>
          </div>
      ...
      <script>
        document.getElementById('whatsapp-form').addEventListener('submit', function(event) {
          ...
          var whatsappMessage = `Nombre: ${name}%0AEmpresa: ${company}%0ASujeto: ${subject}%0AMensaje: ${message}`;
          var phoneNumber = '+51906829934'; // Reemplaza con tu número de teléfono
